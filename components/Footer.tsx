...
export default function Footer() {
  ...
  return (
    <footer className={` text-center ${darkThemes?"bg-teal-900":" bg-gray-900"} text-xl`}>
        <div className={`${darkThemes?"text-black":"text-slate-300"} font-bold p-2 m-1`}>
          Pavel Deniskin
          <br />          
          email: Paveldpv91@gmail.com 
          <button className=' m-2'
          onClick={copyEmailL}
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={`${darkThemes?"white":"red"}`} className="w-4 h-4 ">
          ...
          <br />          
          <a 
          href="https://github.com/paveldpv">
            <img  className=' w-6 h-6  inline-block'
             src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="git"  />
          </a>
        </div>
    </footer>
