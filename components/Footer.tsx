...
export default function Footer() {
  ...
  return (
    <footer 
     className={` text-center ${darkThemes?"bg-teal-900":" bg-gray-900"} text-xl`}>
        <div className={`${darkThemes?"text-black":"text-slate-300"} font-bold p-2 m-1`}>
          ...
          onClick={copyEmailL}
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={`${darkThemes?"white":"green"}`} className="w-6 h-6 ">
